...
This changes no wire schema. Older saved diagnostic records may still contain
the historical false strings; newly applied outcomes and newly generated
reports are clean on both peers.
