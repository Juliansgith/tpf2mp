...
Last updated: 2026-08-04 after prototype `0.21.2-alpha`, state schema `19`,
...
| Contested passenger demand | Deterministic host model with frequency, time, quality, fare, capacity, outside choice, revenue, reach, and wins exists. | Bind/balance against real competing corridors and decide transfer behavior through playtests. |
