...
$budgets = [ordered]@{
    ...
    'tpf2_mp_1\res\scripts\tpf2_mp\economy_clock_runtime.lua' = 85
    ...
    'tpf2_mp_1\res\scripts\tpf2_mp\recovery_action_protocol.lua' = 40
    'tpf2_mp_1\res\scripts\tpf2_mp\result_error.lua' = 30
    ...
    'companion\tpf2mp\relay_diagnostics.py' = 240
    'companion\tpf2mp\diagnostic_cursor.py' = 80
    'companion\tpf2mp\diagnostic_sampling.py' = 70
    ...
    'companion\tpf2mp\anchor_prepare.py' = 275
    'companion\tpf2mp\anchor_prepare_cancel.py' = 50
    ...
    'tpf2_mp_1\res\scripts\tpf2_mp\freight_industry_runtime.lua' = 195
    ...
    'companion\tpf2mp\anchor_state.py' = 135
    ...
    'tpf2_mp_1\res\scripts\tpf2_mp\validation_connected_terminal_runtime.lua' = 80
    'tpf2_mp_1\res\scripts\tpf2_mp\validation_connected_road_depot_proposal.lua' = 70
    'tpf2_mp_1\res\scripts\tpf2_mp\validation_connected_road_depot_runtime.lua' = 100
    'tpf2_mp_1\res\scripts\tpf2_mp\validation_depot_vehicle_purchase.lua' = 110
    'tpf2_mp_1\res\scripts\tpf2_mp\validation_construction_slices.lua' = 40
