...
players. Read the [release notes](docs/release-notes/RELEASE_NOTES_0.45.3-alpha.md)
before testing.
...
verify mods and start. Native world creation, save transfer and loading run
automatically. Existing-save and recovery workflows remain available.
...
```powershell
.\tools\package_release.ps1 -Version 0.45.3-alpha
```
...
.\tools\publish_github_release.ps1 `
  ...
  -ReleaseNotesPath .\docs\release-notes\RELEASE_NOTES_0.45.3-alpha.md `
  -ConfirmPublish
```
