...
players. Read the [release notes](docs/release-notes/RELEASE_NOTES_0.44.2-alpha.md)
before testing.
...
```powershell
.\tools\package_release.ps1 -Version 0.44.2-alpha
```
...
.\tools\publish_github_release.ps1 `
  ...
  -ReleaseNotesPath .\docs\release-notes\RELEASE_NOTES_0.44.2-alpha.md `
  -ConfirmPublish
```
