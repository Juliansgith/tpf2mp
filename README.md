...
This runs the full suite, rebuilds the native DLL/injector, creates a one-file `tpf2mp.exe`, writes strict schema/version/size/SHA-256 metadata for every packaged file, creates `dist\TPF2MP-0.33.0-alpha.zip`, and performs a temporary install/verify/uninstall round trip.
...
- `tpf2_mp_1/` — installable prototype 0.33; state schema 29, economy model 8, checkpoint format 5, passenger-presentation schema 2, cargo-presentation schema 1, delivery schema 2, edge schema 5, construction schema 7, and freight-industry schema 2.
