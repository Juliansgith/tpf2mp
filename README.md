...
- `tpf2_mp_1/` — installable prototype 0.37; state schema 30, economy model 9, checkpoint format 5, passenger-presentation schema 4, cargo-presentation schema 1, delivery schema 2, edge schema 5, construction schema 7, and freight-industry schema 2.
