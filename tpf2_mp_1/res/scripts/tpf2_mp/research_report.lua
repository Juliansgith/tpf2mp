...
local KNOWN_LIMITS = {
  "BuildProposal has a payload-aware pre-mutation gate. Thirty-one additional exact visitor gates cover line/portable-vehicle/name/color, speed, and town/industry autonomy commands. Fifteen operation tags have strict canonical codecs; authored town development, town information, and industry freeze consume exact one-shot authorization. Calendar/logo/field/terrain/date/cheat/person-debug and the other unauthored categories stay fail-closed for player input.",
  ...
  "A READY-gated automatic native save request, stable-file watcher, and ordered peer receipts are implemented and offline-proven. The automatic two-live-process save/reload path and coordinated rollback/relaunch remain open.",
}
