...
function M.new()
  ...
  buildGateLastGenerationSeen = nil,
  buildCorrelation = nil,
  ...
  nativeBuildCapture = {
    ...
    previewFallbacks = 0,
    earlyCaptures = 0,
    earlyCaptureFallbacks = 0,
    earlyCaptureMisses = 0,
    exactEvidenceUpgrades = 0,
    exactEvidenceUpgradeFailures = 0,
    lastEarlyCaptureError = nil,
    ...
    busyRejected = 0,
    busyDeferred = 0,
    correlatedNativeEvents = 0,
    correlationRejects = 0,
    semanticRejects = 0,
    invalidations = 0,
  },
  nativeClockCapture = {
    ...
    invalid = 0,
    duplicates = 0,
    modalPausesIgnored = 0,
    lastRequestedSpeed = nil,
    lastExplicitSpeedFrame = nil,
    lastOperationalModalFrame = nil,
    lastOperationalModalSource = nil,
    lastIgnoredModalPauseFrame = nil,
  },
