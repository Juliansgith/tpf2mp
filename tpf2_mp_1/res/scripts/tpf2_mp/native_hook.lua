    ...
    gates = {
      buildProposal = {
        ...
        factoryCapture = {
          ...
          addFallbackCalls = math.max(0, tonumber(factoryCapture.addFallbackCalls) or 0),
          ...
          retired = math.max(0, tonumber(factoryCapture.retired) or 0),
          orphaned = math.max(0, tonumber(factoryCapture.orphaned) or 0),
          expired = math.max(0, tonumber(factoryCapture.expired) or 0),
          evictedPending = math.max(0, tonumber(factoryCapture.evictedPending) or 0),
          correlationMisses = math.max(0, tonumber(factoryCapture.correlationMisses) or 0),
