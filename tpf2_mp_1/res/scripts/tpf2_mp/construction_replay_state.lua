...
local M = {
  ...
  hasExistingCarrierEndpoint = constructionReplayPolicy.connection.hasExistingCarrierEndpoint,
  isConnectedDepot = constructionReplayPolicy.connection.isConnectedDepot,
